...
A HackerTyper Clone built with React.

## Demo

Type to see the App in action, press "ESC" when "Access Denied" or "Access Granted" appears.

[Link](https://chic-granita-317f8c.netlify.app/)
